...
class Task:
    ...
    def run(self, predictor, cfg):
        ...
        print(f"clip_read_time {clip_read_time:.6f}s")
        for annot in self.annots:
            ...
            if not os.path.isfile(save_path):
                ...
                print(f"extract_time {extract_time:.6f}s")
                torch.save(
...
def main(cfg: DictConfig) -> None:
    ...
    process_anno_time = time.time() - start_time
    print(f"process_anno_time {process_anno_time:.6f}s")
