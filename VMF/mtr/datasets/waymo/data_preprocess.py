...
# Modificatoin: ConfigProto disappeared in tf 2.0
...
if __name__ == '__main__':
    ...
    print(f"Start Waymo data preparation {now}")
    ...
    end_time = time.time()
    print(f"Finish data pre-processing {datetime.datetime.now()}")
    print(f"Elapse {(end_time - start_time):.6f} sec")
